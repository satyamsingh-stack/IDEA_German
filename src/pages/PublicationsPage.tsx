      ...
      <section className="relative py-12 md:py-20 bg-white">
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <p className="text-[#1a2744] text-lg leading-relaxed mb-2">
              For inquiries, submissions, or collaboration, please contact:
            </p>
            <p className="text-[#1a2744] font-medium">Dr. Yeshwant Naik</p>
          ...
          <div className="mb-12">
            ...
            <p className="text-[#1a2744] text-lg leading-relaxed mb-8 break-words">
          ...
          <div>
            ...
            <p className="text-[#1a2744] text-lg leading-relaxed break-words mt-4">
