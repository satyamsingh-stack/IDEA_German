      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-2">
            <p className="text-gray-700 font-medium">Switzerland</p>
            <p className="text-gray-700">IDEA Institute</p>
            <p className="text-gray-700">Missionsstrasse 24</p>
            <p className="text-gray-700">4055 Basel</p>
          ...
          <div className="space-y-2 mt-4">
            <p className="text-gray-700 font-medium">German Affiliate</p>
            <p className="text-gray-700">IDEA gGmbH</p>
            <p className="text-gray-700">Rheinstraße 57</p>
            <p className="text-gray-700">79639 Grenzach-Wyhlen</p>
