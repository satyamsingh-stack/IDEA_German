    ...
    <section className="pt-32 pb-16 bg-white">
      <div className="max-w-full mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
          {/* Left Content - Desktop Version (hidden on mobile) */}
          <div className="col-span-1 lg:col-span-2 space-y-8 hidden lg:block">
            {/* H1 Section - Desktop Only */}
            <div>
          ...
          <div className="col-span-1 flex items-start mt-6 hidden lg:block">
          ...
          <div className="col-span-1 lg:hidden space-y-8">
            {/* H3 Section - Mobile Only */}
            <div>
              <h3 className="text-2xl font-bold text-brand-black mb-6 leading-tight font-sans">
                Willkommen bei IDEA
              </h3>
              <p className="text-gray-700 leading-relaxed mb-6 text-sm font-normal">
